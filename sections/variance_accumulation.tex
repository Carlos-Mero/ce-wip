...
By Lemma~\ref{lem:proximal-gradient-noise}, the sampled gradient has zero mean but generally nonzero variance. Fix a prompt $x$, write $\pi_k=\pi_{\theta_k}(\cdot\mid x)$, and let $\mathcal F_k$ denote the training history before sampling at step $k$. Then we have the following result:
