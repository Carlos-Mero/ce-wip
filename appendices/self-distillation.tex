...
from Qwen3-1.7B-Base. Nearby teachers are obtained by training the same
model with GRPO for 50, 100, or 200 steps. The distal experiments use a
JustRL teacher with R1-Distill-1.5B and Qwen2.5-Math-1.5B students;
...
\begin{itemize}
  ...
  \item JustRL experiments: JustRL training data, maximum response length 8,192;
